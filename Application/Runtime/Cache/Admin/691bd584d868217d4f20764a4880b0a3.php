        ...
        <div class="List">
            <div class="table-list">
                <ul>
                    ...
                    <li class="Property">描述</li>
                    <li class="S_Order">添加时间</li>
            ...
            <?php if(is_array($list)): foreach($list as $k=>$vo): ?><div class="ProList">
                    <ul>
                        ...
                        <li class="Name"><?php echo ($vo["title"]); ?></li>
                        <li class="Property" style="text-align: left;"><?php echo ($vo["info"]); ?></li>
                        <li class="S_Order"><?php echo (date("Y-m-d",$vo["inputtime"])); ?></li>
                        <li class="Status"><?php echo ($vo[status] == 1?'正常':'<font color=red>锁定</font>'); ?></li>
                        <li class="Oper">
                            <div>
                                <a href="<?php echo U('Admin/auth_edit',array('id'=>$vo['id']));?>">编辑</a>
                                <span>|</span>
                                <a href="<?php echo U('Admin/auth_delete',array('id'=>$vo['id']));?>">删除</a>
                            </div>
                        </li>
                    </ul>
