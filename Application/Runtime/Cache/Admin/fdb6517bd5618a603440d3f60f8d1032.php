...
<block name="body">
    ...
    <div class="content">
        <div class="Config_nav">
            <ul>
                <li><a href="<?php echo U('Banner/index');?>">幻灯片管理</a></li>
                <li><a class="on" href="<?php echo U('Banner/add');?>">添加幻灯片</a></li>
            </ul>
        </div>
        <form action="<?php echo U('Banner/insert');?>" method="post"  id="form" enctype="multipart/form-data" >
            <div class="SiteContent">
                <ul>
                    <li class="Name">类型</li>
                    <li class="input">
                        <select name="cid">
                            <option value="0">PC幻灯片</option>
                            <option value="1">WAP幻灯片</option>
                        </select>
                    </li>
                </ul>
                <ul>
                    <li class="Name">幻灯片名称</li>
                    <li class="input"><input class="common-text input-text" name="name" size="40" type="text"></li>
                </ul>
                <ul>
                ...
                <ul>
                    <li class="Name">网址</li>
                    <li class="input"><input class="common-text input-text" name="url" size="40" type="text"></li>
                </ul>
                <ul>
                    <li class="Name">状态</li>
                    <li class="input">
